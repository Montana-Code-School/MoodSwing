  ...
  render () {
    ...
    return (
      <Scene>
        ...
        <Entity primitive='a-text'scale="0.6 1.2 1" value="MOODSWING" color="black" position="-1 2.85 -3" width="3"/>
        <Entity primitive='a-text' value={greet} color="black" position="-1 3 -3"/>
        <Entity primitive='a-plane' rotation="-90 0 0" color="#CCC" height="10" width="10"/> 
      </Scene>
    );
  }
}
